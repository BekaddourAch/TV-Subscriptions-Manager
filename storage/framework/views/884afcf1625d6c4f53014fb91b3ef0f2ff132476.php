            ...
            <div class="shadow dropdown-list dropdown-menu dropdown-menu-right animated--grow-in"
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="mr-3 dropdown-list-image">
                        <img class="rounded-circle" src="<?php echo e(asset('backend/img/undraw_profile_1.svg')); ?>" alt="...">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="mr-3 dropdown-list-image">
                        <img class="rounded-circle" src="<?php echo e(asset('backend/img/undraw_profile_2.svg')); ?>" alt="...">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="mr-3 dropdown-list-image">
                        <img class="rounded-circle" src="<?php echo e(asset('backend/img/undraw_profile_3.svg')); ?>" alt="...">
...
<!-- End of Topbar -->
<?php /**PATH C:\xampp\htdocs\tv-subscriptions-management\resources\views/partial/backend/navbar.blade.php ENDPATH**/ ?>